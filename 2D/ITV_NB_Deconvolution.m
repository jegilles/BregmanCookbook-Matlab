function u=ITV_NB_Deconvolution(f,A,mu,lambda,Niter,typeKernel)

%========================================================================
% function u=ITV_NB_Deconvolution(f,A,mu,lambda,Niter,typeKernel)
%
% Isotropic TV Non-Blind Deconvolution
% Version:
% -v1.2 - 06/20/2013
% -v1.0 - 02/27/2012
%
% This function performs the minimization of the Isotropic TV - L2 
% Rudin-Osher-Fatemi model with a convolution kernel for images by 
