...
figure; subplot(1,2,1);imshow(ND,[]);xlabel('Noisy');subplot(1,2,2);imshow(DND,[]);xlabel('Denoised')
...
%gauss=fspecial('gaussian',9,1.7);
gauss=fspecial('gaussian',19,2.3);
...
figure;subplot(1,3,1);imshow(lena,[]);xlabel('Original');subplot(1,3,2);imshow(BD,[]);xlabel('Blurry');subplot(1,3,3);imshow(abs(DBD),[]);xlabel('Deblurred');
